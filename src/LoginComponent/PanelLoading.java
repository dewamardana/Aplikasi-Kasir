...
public class PanelLoading extends javax.swing.JLayeredPane {
    ...
    private void initComponents() {
        ...
        loading = new LoginSwing.PanelTransparent();
        cmdCancel = new LoginSwing.Button();
        jLabel1 = new javax.swing.JLabel();
        message = new LoginSwing.PanelTransparent();
        cmdCancel2 = new LoginSwing.Button();
        lbMessage = new javax.swing.JLabel();
        profile = new LoginSwing.PanelTransparent();
        cmdCancel1 = new LoginSwing.Button();
        pic = new LoginSwing.ImageAvatar();
        cmdEdit = new LoginSwing.EditButton();
        cmdContinue = new LoginSwing.Button();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LoginIcon/loading.gif")));
        ...
        pic.setBorderSize(3);
        pic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LoginIcon/user.png")));
        pic.setOpaque(true);

        cmdEdit.setBackground(new java.awt.Color(55, 55, 55));
        cmdEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LoginIcon/edit.png")));
    ...
    private void cmdEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdEditActionPerformed
        ...
        if (option == JFileChooser.APPROVE_OPTION) {
            ...
            repaint();
            try {
                String sql = "update `tb_datapetugas` set `Profile`=? where id_petugas=? limit 1";
    ...
    private LoginSwing.Button cmdCancel;
    private LoginSwing.Button cmdCancel1;
    private LoginSwing.Button cmdCancel2;
    private LoginSwing.Button cmdContinue;
    private LoginSwing.EditButton cmdEdit;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JLabel lbMessage;
    private LoginSwing.PanelTransparent loading;
    private LoginSwing.PanelTransparent message;
    private LoginSwing.ImageAvatar pic;
    private LoginSwing.PanelTransparent profile;
